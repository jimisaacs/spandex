...
names every rule and skill and what each governs. Claude gets rules and skills
through two directory symlinks, `.claude/rules` and `.claude/skills`. Cursor
reads `.cursorrules`, which is a symlink to this file.
