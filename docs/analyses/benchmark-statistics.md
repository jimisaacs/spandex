...
- **CV%**: `(σ/μ) × 100` - normalized variability (<5% = stable ✅, >5% = variable ⚠️). Threshold based on conventional benchmark stability standards (CV% <5% indicates measurement precision is high relative to signal)
